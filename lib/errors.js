...
/**
 * Detect errors and work around Error.isError() not treating DOMException as an error
 */
const isError = (error) => {
...
export const throwFetchError = (request, options, error) => {
...
export const handleResponse = async (request, options, response) => {
